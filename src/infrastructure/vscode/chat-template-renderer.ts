...
export class ChatTemplateRenderer {
  ...
  public async render(webview: vscode.Webview): Promise<string> {
    ...
    const syntaxScriptUri = webview.asWebviewUri(
      vscode.Uri.joinPath(this.extensionUri, "static", "vendor", "syntax-highlighter.js")
    );
    ...
    const replacements: Readonly<Record<string, string>> = {
      ...
      "{{executionReferencesScriptUri}}": webview.asWebviewUri(vscode.Uri.joinPath(this.extensionUri, "static", "js", "execution-references.js")).toString(),
